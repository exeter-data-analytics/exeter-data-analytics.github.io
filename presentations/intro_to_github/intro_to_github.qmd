...
-   Size of each file in it cannot <br> exceed 100 MB (warnings \> 50GB)^1^
...
::: footer
[1. Merge conflicts with CSV files in git ](https://paulfitz.github.io/2014/07/09/diff-merge-csv.html)

[2. "using Git for data is...like using a hammer to fasten a screw."](https://www.dolthub.com/blog/2022-04-27-data-version-control)
