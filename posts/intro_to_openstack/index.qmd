...
::: callout-caution
Note that the RStudio Server interface requires you to use a username and password combination. So, this example will only work if you chose [Option 2](#sec-option-2) in the *Cloud Config* section.
:::
