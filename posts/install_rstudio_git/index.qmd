...
Once you have set this, you can check it has stored properly using **gitcreds::gitcreds::get()**. 
...
- We enjoyed [this thread](https://community.rstudio.com/t/should-i-update-all-my-r-packages-frequently-yes-no-why/5856/6) on whether we should update our R packages regularly. In conclusion, yes probably.
